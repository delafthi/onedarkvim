...
call <Sid>X('LineNr'       , s:mono2        , s:black    , 'none')         " Line number for':number' and ':#' commands, and when 'number' or 'relativenumber' option is set.
...
call <Sid>X('NonText'      , s:mono3        , s:none    , 'none')         " '~' and '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g. , '>' displayed when a double-wide character doesn't fit at the end of the line).
...
call <Sid>X('SpecialKey'   , s:mono3        , s:none    , 'none')         " Meta and special keys listed with ':map', also for text used to show unprintable characters in the text, 'listchars'. Generally: text that is displayed differently from what it really is.
...
call <Sid>X('TabLineSel'   , s:white        , s:mono1   , 'none')         " tab  pages line, active tab page label
...
" Asciidoc
call <Sid>X('asciidocListingBlock' , s:mono4 , s:none , 'none')
...
call <Sid>X('cucumberTags'            , s:mono3  , s:none , 'bold')
call <Sid>X('cucumberDelimiter'       , s:mono3  , s:none , 'bold')

" CSS/Sass
call <Sid>X('cssAttrComma'         , s:purple , s:none , 'none')
call <Sid>X('cssAttributeSelector' , s:green  , s:none , 'none')
call <Sid>X('cssBraces'            , s:mono4  , s:none , 'none')
...
call <Sid>X('gitcommitComment'        , s:mono3  , s:none , 'none')
...
call <Sid>X('gitcommitUntracked'      , s:mono3  , s:none , 'none')
call <Sid>X('gitcommitDiscarded'      , s:mono3  , s:none , 'none')
...
call <Sid>X('javaScriptBraces'               , s:mono4    , s:none , 'none')
...
call <Sid>X('jsBraces'                       , s:mono4    , s:none , 'none')
call <Sid>X('jsClassBraces'                  , s:mono4    , s:none , 'none')
...
call <Sid>X('jsFuncBraces'                   , s:mono4    , s:none , 'none')
call <Sid>X('jsFuncCall'                     , s:blue     , s:none , 'none')
call <Sid>X('jsFuncParens'                   , s:mono4    , s:none , 'none')
...
call <Sid>X('javascriptEndColons'            , s:mono3    , s:none , 'none')
...
call <Sid>X('jsonQuote'              , s:mono3  , s:none , 'none')
...
" Markdown
call <Sid>X('markdownUrl'              , s:mono3    , s:none , 'none')
call <Sid>X('markdownBold'             , s:orange   , s:none , 'bold')
call <Sid>X('markdownItalic'           , s:orange   , s:none , 'bold')
call <Sid>X('markdownCode'             , s:green    , s:none , 'none')
call <Sid>X('markdownCodeBlock'        , s:red      , s:none , 'none')
call <Sid>X('markdownCodeDelimiter'    , s:green    , s:none , 'none')
call <Sid>X('markdownHeadingDelimiter' , s:red_dark , s:none , 'none')
call <Sid>X('markdownH1'               , s:red      , s:none , 'none')
call <Sid>X('markdownH2'               , s:red      , s:none , 'none')
call <Sid>X('markdownH3'               , s:red      , s:none , 'none')
call <Sid>X('markdownH3'               , s:red      , s:none , 'none')
call <Sid>X('markdownH4'               , s:red      , s:none , 'none')
call <Sid>X('markdownH5'               , s:red      , s:none , 'none')
call <Sid>X('markdownH6'               , s:red      , s:none , 'none')
call <Sid>X('markdownListMarker'       , s:red      , s:none , 'none')
...
call <Sid>X('phpParent'       , s:mono3  , s:none , 'none')
...
call <Sid>X('pugDocType'             , s:mono3  , s:none , 'italic')
...
call <Sid>X('zshSubstDelim'  , s:mono3  , s:none , 'none')
...
call <Sid>X('SpecialComment'           , s:mono3 , s:none , 'none')
call <Sid>X('rustCommentLine'          , s:mono3 , s:none , 'none')
call <Sid>X('rustCommentLineDoc'       , s:mono3 , s:none , 'none')
call <Sid>X('rustCommentLineDocError'  , s:mono3 , s:none , 'none')
call <Sid>X('rustCommentBlock'         , s:mono3 , s:none , 'none')
call <Sid>X('rustCommentBlockDoc'      , s:mono3 , s:none , 'none')
call <Sid>X('rustCommentBlockDocError' , s:mono3 , s:none , 'none')

" Man
call <Sid>X('manTitle'  , s:green  , s:none   , 'none')
call <Sid>X('manFooter' , s:mono3  , s:none   , 'none')
...
call <Sid>X('netrwComment'  , s:mono3      , s:none , 'none')
call <Sid>X('netrwList'     , s:blue_light , s:none , 'none')
call <Sid>X('netrwHelpCmd'  , s:mono3      , s:none , 'none')
...
call <Sid>X('StartifySpecial' , s:mono3  , s:none , 'none')
...
call <Sid>X('LspReferenceText'                     , s:mono4  , s:none , 'none') " used for highlighting 'text' references
call <Sid>X('LspReferenceRead'                     , s:mono4  , s:none , 'none') " used for highlighting 'read' references
call <Sid>X('LspReferenceWrite'                    , s:mono4  , s:none , 'none') " used for highlighting 'write' references
...
call <Sid>X('LspDiagnosticsDefaultHint'            , s:mono4  , s:none , 'none') " Used as the base highlight group. Other LspDiagnostic highlights link to this by default (except Underline)
...
call <Sid>X('LspDiagnosticsVirtualTextHint'        , s:mono4  , s:none , 'none') " Used for 'Hint' diangostic virtal text. See vim.lsp.diagnsotic.set_virtual_text()
...
call <Sid>X('LspDiagnosticsUnderlineHint'          , s:mono4  , s:none , 'none') " Used to underline 'Hint' diagnostics. See vim.lsp.diagnostic.set_underline()
...
call <Sid>X('LspDiagnosticsFloatHint'              , s:mono4  , s:none , 'none') " Used to color 'Hint' diagnostic messages in diagnostics float. See vim.lsp.diagnsotic.show_line_diagnostics()
...
call <Sid>X('LspDiagnosticsSignHint'               , s:mono4  , s:none , 'none') " Used to color 'Hint' signs in sign column. See vim.lsp.diagnostic.set_signs()
